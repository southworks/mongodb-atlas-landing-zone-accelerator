locals {
  ...
  region_definitions = {
    ...
    zoneB = {
      ...
      app_workload_subnet_prefixes      = ["10.0.1.0/28"]
      test_app_subnet_prefixes          = ["10.0.1.16/28"] # This subnet is for step 2, which is optional and used to validate the connection with the cluster.
    ...
    zoneC = {
      ...
      app_workload_subnet_prefixes      = ["10.0.1.32/28"]
      test_app_subnet_prefixes          = ["10.0.1.48/28"] # This subnet is for step 2, which is optional and used to validate the connection with the cluster.
